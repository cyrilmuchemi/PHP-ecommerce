                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="row border-top py-3 mt-3">
                            <div class="col-sm-2">
                                <img src="./assets/products/1.png" style="height: 120px;" alt="product 1"/>
                            </div>
                            <div class="col-sm-8">
                              <h5 class="font-open font-size-20">Samsung Galaxy</h5>
                              <small>by Samsungs</small>
                              <div class="d-flex">
                            ...
                            <div class="col-sm-2 text-right">
                              <div class="font-size-20 text-danger font-open">
                                KSh<span class="product_price">20,000</span>
                              </div>
                            </div>
                        </div>
                        <div class="row border-top py-3 mt-3">
                          <div class="col-sm-2">
                              <img src="./assets/products/2.png" style="height: 120px;" alt="product 1"/>
                          </div>
                          <div class="col-sm-8">
                            <h5 class="font-open font-size-20">Redmi Note 7</h5>
                          ...
                          <div class="col-sm-2 text-right">
                            <div class="font-size-20 text-danger font-open">
                              KSh<span class="product_price">15,200</span>
                            </div>
                          </div>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="sub-total mt-2 border text-center">
                        ...
                        <div class="border-top py-4">
                          <h5 class="font-open font-size-16">Subtotal (2 items):&nbsp;<span class="text-danger" id="deal-price">KSh40,000</span></h5>
